...
import { queryGetProposal, queryGetQuoteItem} from "@/lib/api/services/ali.service";
import { GetLookup } from "@/lib/api/services/search.service";
import { createAgreementLineItem, getAgreementLineItems, updateAgreementLineItem, getAgreementById} from "@/lib/api/services/agreement.service";
...
//   const acc = useLocation();
  const acc = typeof window !== 'undefined' ? (JSON.parse(sessionStorage.getItem("AccountDetails") || '{}') || {}) : {};
 ...
 const agreementName = typeof window !== 'undefined' ? sessionStorage.getItem("agreementName") : '';
 const pageSize = 5;
 ...
 try {
    const response = await getAgreementById(acc.Id);
